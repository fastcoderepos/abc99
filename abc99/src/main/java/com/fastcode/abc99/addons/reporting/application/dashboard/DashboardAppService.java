package com.fastcode.abc99.addons.reporting.application.dashboard;

import com.fastcode.abc99.addons.reporting.application.dashboard.dto.*;
import com.fastcode.abc99.addons.reporting.application.dashboardversion.IDashboardversionAppService;
import com.fastcode.abc99.addons.reporting.application.dashboardversion.IDashboardversionMapper;
import com.fastcode.abc99.addons.reporting.application.dashboardversion.dto.CreateDashboardversionInput;
import com.fastcode.abc99.addons.reporting.application.dashboardversion.dto.CreateDashboardversionOutput;
import com.fastcode.abc99.addons.reporting.application.dashboardversion.dto.UpdateDashboardversionInput;
import com.fastcode.abc99.addons.reporting.application.dashboardversion.dto.UpdateDashboardversionOutput;
import com.fastcode.abc99.addons.reporting.application.dashboardversionreport.IDashboardversionreportAppService;
import com.fastcode.abc99.addons.reporting.application.report.IReportAppService;
import com.fastcode.abc99.addons.reporting.application.report.IReportMapper;
import com.fastcode.abc99.addons.reporting.application.report.dto.CreateReportInput;
import com.fastcode.abc99.addons.reporting.application.report.dto.CreateReportOutput;
import com.fastcode.abc99.addons.reporting.application.report.dto.FindReportByIdOutput;
import com.fastcode.abc99.addons.reporting.application.report.dto.UpdateReportInput;
import com.fastcode.abc99.addons.reporting.domain.dashboard.IDashboardRepository;
import com.fastcode.abc99.addons.reporting.domain.dashboardversion.IDashboardversionRepository;
import com.fastcode.abc99.addons.reporting.domain.dashboardversionreport.IDashboardversionreportRepository;
import com.fastcode.abc99.addons.reporting.domain.dashboard.QDashboardEntity;
import com.fastcode.abc99.addons.reporting.domain.report.ReportEntity;
import com.fastcode.abc99.addons.reporting.domain.dashboard.DashboardEntity;
import com.fastcode.abc99.addons.reporting.domain.reportversion.ReportversionEntity;
import com.fastcode.abc99.addons.reporting.domain.reportversion.ReportversionId;
import com.fastcode.abc99.addons.reporting.domain.dashboardversion.DashboardversionEntity;
import com.fastcode.abc99.addons.reporting.domain.dashboardversion.DashboardversionId;
import com.fastcode.abc99.addons.reporting.domain.dashboardversionreport.DashboardversionreportEntity;
import com.fastcode.abc99.addons.reporting.domain.dashboardversionreport.DashboardversionreportId;
import com.fastcode.abc99.domain.extended.authorization.user.IUserRepositoryExtended;
import com.fastcode.abc99.domain.core.authorization.user.UserEntity;
import com.fastcode.abc99.addons.reporting.domain.report.IReportRepository;
import com.fastcode.abc99.addons.reporting.domain.reportversion.IReportversionRepository;
import com.fastcode.abc99.commons.search.*;
